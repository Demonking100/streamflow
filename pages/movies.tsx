    ...
    <>
      ...
      >
        ...
        <main className="relative px-4 pb-20 space-y-16 lg:space-y-24 lg:px-12">
          <Banner trendingNow={streamflowOriginals} />
          <section className="space-y-4 md:space-y-8">
            <Row title="streamflow Originals" movies={streamflowOriginals} />
...
export const getServerSideProps = async (context: NextPageContext) => {
  ...
  const [
    ...
    fetch(requests.fetchstreamflowOriginals).then((res) => res.json()),
  ...
  return {
    props: {
      streamflowOriginals: streamflowOriginals.results,
